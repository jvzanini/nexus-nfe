...
const ALL_ROLES: RoleOption[] = [
  ...
  },
  {
    value: "manager",
    label: "Gerente",
    description: "Acompanha indicadores e executa ações",
  },
  {
    value: "viewer",
    label: "Visualizador",
...
export function UsersContent({ isSuperAdmin, currentUserId }: UsersContentProps) {
  ...
  function handleSubmitCreate() {
    ...
    startSaving(async () => {
      const roleMap: Record<string, "super_admin" | "admin" | "manager" | "viewer"> = {
      ...
      const result = await createUser({
        ...
        platformRole: roleMap[form.role] ?? "viewer",
      });
                    ...
                    <TableCell className="text-center">
                      {(() => {
                        ...
                        const roleSelectOptions = (isSuperAdmin ? [
                          ...
                          { value: "admin", label: "Admin", description: "Gerencia usuários e operações", bg: "bg-blue-500/10 border-blue-500/30 text-blue-600 dark:text-blue-400", icon: ShieldCheck },
                          { value: "manager", label: "Gerente", description: "Acompanha indicadores e executa ações", bg: "bg-amber-500/10 border-amber-500/30 text-amber-600 dark:text-amber-400", icon: Shield },
