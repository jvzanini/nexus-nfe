  ...
  const sidebarContent = (
    <div className="flex h-full flex-col bg-background border-r border-border overflow-y-auto">
      ...
      <div className="flex items-center gap-3 px-6 py-6">
        <div className="flex h-10 w-10 items-center justify-center rounded-[22%] bg-gradient-to-br from-violet-600 to-purple-600 shadow-[0_0_12px_rgba(124,58,237,0.3)] shrink-0">
          <Receipt className="h-5 w-5 text-white" />
        </div>
        <div>
          <h1 className="text-base font-bold text-foreground tracking-tight">{APP_CONFIG.name}</h1>
          <p className="text-[11px] text-muted-foreground leading-none">Emissão de NFe MEI</p>
        </div>
      </div>
